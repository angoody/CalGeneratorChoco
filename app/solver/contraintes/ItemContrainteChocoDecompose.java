...
public abstract class ItemContrainteChocoDecompose <T> extends ContrainteChoco<T> {
    ...
    public ItemContrainteChocoDecompose(Model model, ConstraintPriority<T> contrainte, List<ModuleChoco> modulesInChoco, ListeContrainteChoco parent) {
